...
<head>
    ...
    <title>Formulário do médico</title>
...
<body>
    ...
    <header>
        ...
        <p class="pagina-inicial">Página inicial</p>
    </header>
    ...
    <main>
        <form action="../medico/cadastro_medico.php" method="post">
            <div class="form">
                <table align="center">
                    <thead>
                        <tr>
                    ...
                    <tr>
                        <td><input type="text" name="nome_medico" placeholder="Digite o seu nome completo"></td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <select name="id_especialidade" id="">
                                <?php 
                                include('conexao.php');
                                $sql = "Select id_especialidade from especialidade";
                                $resp = mysqli_query($id,$sql);
                                while ($item = mysqli_fetch_array($resp)) { ?> 
                                    <option value="<?php echo $item['id_especialidade']?>"><?php echo $item['id_especialidade']?></option>
                                <?php } ?>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="text" name="crm" placeholder="Digite o seu CRM"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="text" name="rqe" placeholder="Digite o seu RQE"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="text" name="telefone" placeholder="Digite o seu telefone"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="text" name="endereco" placeholder="Digite o seu endereço"></td>
                    </tr>
