    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="edita_consulta.php?id_consulta=<?php echo $linha['id_consulta']; ?>"><p style="color: #373638;">Editar</p></a></td>
                <td><a href="deleta_consulta.php?id_consulta=<?php echo $linha['id_consulta']; ?>"><p style="color: #373638;">Excluir</p></a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
