...
<main>
    <form action="../consulta/atualiza_consulta.php" method="post">
        <div class="form">
            <table border="1" align="center">
                ...
                <tr>
                    <th>Status:</th>
                    <td><input type="text" name="status" value="<?php echo $linha['status']; ?>"></td>
                </tr>

                <tr>
                    <th>Encaminhamento:</th>
                    <td><input type="text" name="encaminhamento" value="<?php echo $linha['encaminhamento']; ?>"></td>
                </tr>

                <tr>
                    <th>Observações:</th>
                    <td><input type="text" name="observacoes" value="<?php echo $linha['observacoes']; ?>"></td>
                </tr>

                <tr>
                    <td colspan="5" align="center">
                        <input type="submit" value="Editar pós-consulta">
                    </td>
                </tr>
