  ...
  <ul>
    <li><a href="../medico/pagina_inicial_medico.html">Página inicial</a></li>
      <li><a href="../consulta/form_consulta.php">Cadastro de consulta</a></li>
            ...
            <li><a href="../paciente/lista_pacientesusuario.php">Pacientes</a></li>
            <li><a href="../consulta/lista_consulta.php">Consultas</a></li>
  </ul>
  <div class="sair">
     ...
     <div class="container">
        <table>
            ...
            <tr>
                ...
                <th>Telefone</th>
                <th>Email</th>
                <th>  <?php if (!empty($linha['laudo'])) { ?>
                            <a href="../paciente/uploads/<?php echo $linha['laudo']; ?>"
                               download
                ...
                <?php
                        ...
                        <tr><td><?php echo $linha['id_paciente'];?></td>
                            ...
                            <td><?php echo $linha['laudo'];?></td>
                              ...
                              <td><a href='edita_paciente.php?id_paciente=<?php echo $linha['id_paciente'];?>'><p
                      style='color: #373638;'>Editar</p></td>
                <td><a href='deleta_paciente.php?id_paciente=<?php echo $linha['id_paciente'];?>'><p
