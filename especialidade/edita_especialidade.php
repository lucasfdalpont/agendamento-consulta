...
$sql = 'Select * from especialidade where id_especialidade='.$id_especialidade;
...
<link rel="stylesheet" href="estilo_especialidade.css">
<body>
    <main>
        ...
        <header>
            ...
            <p class="especialidade">Cadastro de especialidade</p>
        </header>
      ...
      <li><a href="../especialidade/lista_especialidade.php">Especialidades</a></li>
        ...
        <form action="../especialidade/atualiza_especialidade.php" method="post">
            <div class="form">
                <table border="1" align="center">
                    <input type="hidden" name="id_especialidade" value="<?php echo $id_especialidade; ?>">
                    <thead>
                        <th colspan="2" class="especialidadee">Especialidade</th>
                    </thead>
